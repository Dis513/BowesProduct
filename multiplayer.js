...
class MultiplayerManager {
    ...
    async initialize() {
        try {
            ...
            // Use default localhost or configurable server URL
            const serverUrl = localStorage.getItem('colyseusServer') || 'wss://2567-456c8241-fa18-4d99-bd19-14cc734bc3c0.sandbox-service.public.prod.myninja.ai';
